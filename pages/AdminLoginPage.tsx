                    ...
                    <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md mb-6 shadow-md" role="alert">
                        <div className="flex">
                            ...
                            <div>
                                ...
                                <p className="text-sm">Please ensure your <code className="bg-gray-200 text-gray-800 p-1 rounded-sm">DATABASE_URL</code> environment variable is correctly configured for a <strong>PostgreSQL</strong> database and that the server has been restarted.</p>
                            </div>
                        </div>
                    </div>
                )}
