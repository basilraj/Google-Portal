...
export const INITIAL_JOBS: Job[] = [
  ...
  { id: '2', title: 'SSC Combined Graduate Level (CGL) Exam', department: 'Staff Selection Commission', category: 'Central Government', description: '...', qualification: 'Graduate', vacancies: '8000', postedDate: '2025-10-05', lastDate: '2025-11-25', applyLink: '#', status: 'active', createdAt: new Date().toISOString() },
  ...
  { id: '4', title: 'UPSC Civil Services Exam (IAS/IPS)', department: 'Union Public Service Commission', category: 'Civil Services', description: '...', qualification: 'Graduate', vacancies: '1011', postedDate: '2025-09-15', lastDate: '2025-10-10', applyLink: '#', status: 'active', createdAt: new Date().toISOString() },
  ...
  { id: '20', title: 'BARC Scientific Officer', department: 'Bhabha Atomic Research Centre', category: 'Research', description: '...', qualification: 'B.E/B.Tech/M.Sc', vacancies: 'N/A', postedDate: '2025-12-05', lastDate: '2026-01-30', applyLink: '#', status: 'active', createdAt: new Date().toISOString() },
];
...
export const initialAdSettings: AdSettings = {
  ...
  sponsoredAds: [],
  adNetworks: {
    googleAdSense: { code: '<!-- Google AdSense Code -->', notes: 'Main display ad unit.' },
    adsterra: { code: '<!-- Adsterra Pop-under Code -->', notes: 'Sitewide pop-under.' },
    mediaNet: { code: '<!-- Media.net Contextual Ad Code -->', notes: 'Use for in-content ads.' },
    ezoic: { code: '<!-- Ezoic Placeholder ID -->', notes: 'Usually handled by Ezoic plugin, but can store main placeholder here.' },
    propellerAds: { code: '<!-- PropellerAds Push Notification Code -->', notes: 'For push notifications.' },
  },
  activeTests: [],
};
...
export const initialGeneralSettings: GeneralSettings = {
  siteTitle: 'Jobtica',
  siteIconUrl: 'data:image/png;base64,',
