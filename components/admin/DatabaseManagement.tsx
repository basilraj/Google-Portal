        ...
        <div className="bg-white p-6 rounded-lg shadow-sm max-w-4xl mx-auto space-y-8">
                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className="text-sm text-blue-700">
                            This application is built to use a <strong>PostgreSQL</strong> database. While MySQL is an excellent database choice, it is not directly compatible. To connect a database, you will need a PostgreSQL-compatible connection string.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="space-y-6">
                    <div>
                        <h4 className="font-semibold text-lg text-gray-800">1. Get a PostgreSQL Database</h4>
                        <p className="mt-1 text-gray-600">You'll need a PostgreSQL database. For cloud hosting, services like <a href="https://neon.tech/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Neon</a>, <a href="https://railway.app/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Railway</a>, or your cloud provider's managed SQL service are great options. For local development, you can install PostgreSQL Server directly.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-4 border p-4 rounded-md">
                            ...
                            <CodeBlock>{`DATABASE_URL="postgresql://user:password@localhost:5432/jobtica"`}</CodeBlock>
                        </div>
                        
                        <div className="mt-4 border p-4 rounded-md">
                             <h5 className="font-semibold text-gray-700 flex items-center gap-2"><Icon name="cloud" /> For Render/Vercel Deployment</h5>
                             <ol className="list-decimal list-inside mt-1 text-sm text-gray-600 space-y-1">
                                <li>Go to your backend service dashboard on Render/Vercel.</li>
                                <li>Click on the "Environment" tab (or "Environment Variables" under "Settings" for Vercel).</li>
                                ...
                                <li>If you are using Render/Neon's own database service, this variable may be automatically injected for you.</li>
                             </ol>
                        </div>
                    </div>
